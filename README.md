...
|   송현준 	|   	|
|   홍도현 	|   	|
|   김민석  	|   백엔드에 대해 거의 모르는 상태에서 처음으로 백엔드 프로젝트를 진행하게 되었습니다. 자바조차 많이 익숙하지 않은 상황이었기에, 설 연휴 동안 시간을 들여 백엔드에 대해 집중적으로 공부했습니다. 여러 블로그를 참고하며 코드 작성 방법과 비즈니스 로직 설계 방식에 익숙해지려 노력했고, 전체적인 흐름도 점점 이해할 수 있게 되었습니다. |
